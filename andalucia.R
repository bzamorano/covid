...
dd%>%
  ...
  annotate("text", x=LastDay-86400*75, y=1500, label= LastDay) +
  annotate("text", x=LastDay-86400*75, y=1400, label= paste("Andalucía:", round(IncTot))) +
  annotate("text", x=LastDay-86400*75, y=1300, label= paste("Granada:", round(IncGRX)))
